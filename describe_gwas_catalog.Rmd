...
titles <- gwas_cancer_data %>%
	...
	mutate(
		...
		traits = str_replace_all(traits, "her2\\+", "her2 positive"),   # change her2+ to her2 positive
 		traits = str_replace_all(traits, " r\\+", "r positive"),   # change er+ or pr+ to er positive
