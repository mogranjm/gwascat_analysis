...
To determine which malignancies are ready for clinical polygenic risk assessment, we are analysing the NHGRI-EBI Catalog of published genome-wide association studies, applying ** criteria to identify malignancies with robust evidence suggesting the polygenic component of their risk is reliably quantifiable.
