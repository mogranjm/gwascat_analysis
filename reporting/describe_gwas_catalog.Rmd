...
```
# ```{r}
# clean_cancer_pubs <- function(data, class_col, text_filter_col, keep_cols, ...){
# 	
# 	require(rlang)
# 	require(dplyr)
# 	require(stringr)
# 	
# 	exclude_string <- paste(..., sep = "|", collapse = "|")
# 	
# 	data %>% 
# 		select(keep_cols, text_filter_col, class_col ) %>% 
# 		filter(
# 			{{ class_col }} == TRUE,
# 			!str_detect({{ text_filter_col }}, exclude_string)
# 		)
# }
# ```
...
```{r}
thyroid_selected <- cancer_classes %>% 
